...
const AboutPage: NextPage<Props> = ({}) => {
  return (
    <div>
      <Navbar />
      <div className="p-5 px-5 lg:px-52 pt-24">
        <p className="text-xl font-semibold">Our Team ~</p>
        <p className="text-muted-foreground w-4/5">
          &quot;He seamlessly blends into both the backend and frontend worlds,
          not originating from a single discipline. When he is praised, it is
          for his versatile skills. At times, he feels the full weight of
          complex projects. Yet, no challenge can deter him from mastering
          similar feats in technology and design.&quot;
        </p>
        <div className="grid md:grid-cols-4 pt-5 grid-cols-2">
